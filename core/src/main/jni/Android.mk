...
COMMON_SOURCE := json/json_valueiterator.inl json/json_value.cpp json/json_writer.cpp json/json_reader.cpp GlobalOperate.cpp encode.cpp NodeInfo.cpp yrc4.cpp
LOCAL_MODULE := common
LOCAL_SRC_FILES := $(addprefix common/, $(COMMON_SOURCE))

LOCAL_CPPFLAGS := -std=c++11 -fexceptions -I$(LOCAL_PATH)/common
...
#SHADOWSOCKS_SOURCES := local.cpp cache.c udprelay.c utils.c netutils.c json.c jconf.c acl.c rule.c crypto.c aead.c stream.c base64.c plugin.c ppbloom.c android.c

#LOCAL_SRC_FILES := $(addprefix shadowsocks-libev/src/, $(SHADOWSOCKS_SOURCES))

#SHADOWSOCKS_SOURCES := main.cpp ServiceClient.cpp samapacket.c src/cache.c src/udprelay.c src/utils.c src/netutils.c src/acl.c src/rule.c src/crypto.c src/aead.c src/stream.c src/base64.c src/plugin.c src/ppbloom.c src/android.c

SHADOWSOCKS_SOURCES := samalocal.cpp samapacket.c src/json.c src/jconf.c src/cache.c src/udprelay.c src/utils.c src/netutils.c src/acl.c src/rule.c src/crypto.c src/aead.c src/stream.c src/base64.c src/plugin.c src/ppbloom.c src/android.c

LOCAL_SRC_FILES := $(addprefix shadowsocks-libev/, $(SHADOWSOCKS_SOURCES))
...
LOCAL_CFLAGS    := -Wall -fno-strict-aliasing -DMODULE_LOCAL \
					...
					-I$(LOCAL_PATH)/libev -I$(LOCAL_PATH)

LOCAL_STATIC_LIBRARIES := libev libmbedtls libipset libcork libbloom libsodium libancillary libpcre libcommon
...
LOCAL_C_INCLUDES := $(LOCAL_PATH) $(LOCAL_PATH)/pcre
...
#REDSOCKS_SOURCES := redsocks/base.c redsocks/http-connect.c \
...
#	libevent/buffer.c libevent/bufferevent.c libevent/event.c \
#	libevent/bufferevent_sock.c libevent/bufferevent_ratelim.c \
#	libevent/evthread.c libevent/log.c libevent/evutil.c libevent/evutil_rand.c libevent/evutil_time.c libevent/evmap.c libevent/epoll.c \
#	libevent/poll.c libevent/signal.c libevent/select.c
...
LOCAL_CFLAGS := -Wall -std=gnu99 -Wparentheses -Wimplicit-function-declaration -DUSE_IPTABLES -D_GNU_SOURCE \
